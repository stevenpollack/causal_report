...
Before presenting results, we present the empirical bootstrap sampling distributions in Figure \ref{fig:weight.dist}   to show that all of the distributions look approximately normal.

Point estimates for the three estimators that incorporate and do not incorporate survey weights can be seen in Table \ref{tab:ests}.
